  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        {/* Header Section */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-white mb-2">Create Monitor</h1>
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-lg text-gray-300 leading-relaxed max-w-2xl">
              ...
              Expand Advanced Settings below.
            </p>
          </div>
            ...
            <div className="p-8 border-b border-neutral-800">
              ...
              <div className="space-y-6">
                <select
                  ...
                  className="w-full max-w-md border px-4 py-3 text-lg rounded-xl border-neutral-700 bg-neutral-800/50 text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:ring-opacity-50 transition-all duration-200 hover:border-neutral-600 focus:outline-none"
                >
                  <option
                    value=""
                    disabled
                ...
                {needsKeyword && (
                  <div className="space-y-3 max-w-md">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 text-lg rounded-xl border border-neutral-700 bg-neutral-800/50 text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 focus:ring-opacity-50 transition-all duration-200 hover:border-neutral-600 focus:outline-none"
                    />
            ...
            <div className="p-8">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 text-lg rounded-xl border border-neutral-700 bg-neutral-800/50 text-white placeholder-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 focus:ring-opacity-50 transition-all duration-200 hover:border-neutral-600 focus:outline-none"
                />
          ...
          <div className="flex justify-end space-x-4 pt-6">
            <Link
              href={"/monitor"}
              className="px-8 py-3 text-gray-300 border border-neutral-700 rounded-xl hover:bg-neutral-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-neutral-600"
            >
              Cancel
            </Link>
